        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prerequisites = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FatherName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    RegistrationNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Password = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MobileNo = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ResourceScope = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Religon = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    GuardianName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    GuardianContactNo = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    EmergencyContactNo = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    PreviousQualification = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    InstituteName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    PassingYear = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    MarksAverage = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssessmentSchedule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssessmentSchedule_Assessment_AssessmentId",
                        column: x => x.AssessmentId,
                        principalTable: "Assessment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssessmentSchedule_Batch_BatchId",
                        column: x => x.BatchId,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AssessmentSchedule_Subject_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subject",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchFee", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BatchFee_Batch_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remarks = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchStudent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BatchStudent_Batch_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BatchStudent_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssessmentScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SubmissionUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submission_AssessmentSchedule_AssessmentScheduleId",
                        column: x => x.AssessmentScheduleId,
                        principalTable: "AssessmentSchedule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ReceiptUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    BatchFeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Payment_BatchFee_BatchFeeId",
                        column: x => x.BatchFeeId,
                        principalTable: "BatchFee",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssessmentSchedule_AssessmentId",
                table: "AssessmentSchedule",
                column: "AssessmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssessmentSchedule_BatchId",
                table: "AssessmentSchedule",
                column: "BatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssessmentSchedule_SubjectId",
                table: "AssessmentSchedule",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchFee_BatchId",
                table: "BatchFee",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchStudent_BatchId",
                table: "BatchStudent",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchStudent_StudentId",
                table: "BatchStudent",
                column: "StudentId");
